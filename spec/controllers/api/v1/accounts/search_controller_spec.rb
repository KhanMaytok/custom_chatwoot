...
RSpec.describe 'Search', type: :request do
  ...
  before do
    ...
    conversation = create(:conversation, account: account, contact_id: contact.id, assignee: agent)
    ...
    context 'when it is an authenticated user' do
      ...
      context 'with advanced_search feature enabled', :opensearch do
        ...
        it 'filters conversations by since parameter' do
          ...
          old_conversation = create(:conversation, account: account, contact: old_contact, assignee: agent)
          recent_conversation = create(:conversation, account: account, contact: recent_contact, assignee: agent)
        ...
        it 'filters conversations by both since and until parameters' do
          ...
          old_contact = create(:contact, email: "old-#{unique_id}@test.com", account: account)
          recent_contact = create(:contact, email: "recent-#{unique_id}@test.com", account: account)
          very_old_conversation = create(:conversation, account: account, contact: very_old_contact, assignee: agent)
          old_conversation = create(:conversation, account: account, contact: old_contact, assignee: agent)
          recent_conversation = create(:conversation, account: account, contact: recent_contact, assignee: agent)
